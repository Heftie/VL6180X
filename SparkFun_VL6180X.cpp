...
void VL6180x::VL6180xDefautSettings(void){
  ...
  VL6180x_setRegister(VL6180X_SYSTEM_MODE_GPIO0, 0x0); // Set GPIO1 high when sample complete
...
uint16_t VL6180x::getDistance(){
  ...
  delay(10);
  rangeValue = VL6180x_getRegister(VL6180X_RESULT_RANGE_VAL); //load Value
  return (2 * (uint16_t)rangeValue); //multiply value with scaler and return
